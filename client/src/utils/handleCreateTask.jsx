...
import { getMinDate } from './dateHandlers'
...
export async function handleCreateTask(e, formData, setInvalidData, token, setFormData, modalRef, setAllTasks) {
    e.preventDefault()
    ...
    try {
        ...
        setAllTasks(getAllTasks.data.tasks)
